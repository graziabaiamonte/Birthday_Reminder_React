...
const SAUCE_CONNECT_PLATFORM_DATA = {
  darwin: {
...
exports.SAUCE_CONNECT_PLATFORM_DATA = SAUCE_CONNECT_PLATFORM_DATA;
...
const protocols = [require('../apis/sauce.json'), require('../apis/rdc.json'), require('../apis/performance.json'), require('../apis/testcomposer.json'), require('../apis/datastore.json'), require('../apis/autonomiq.json'), require('../apis/teamManagement.json'), require('../apis/builds.json')];
...
const SC_BOOLEAN_CLI_PARAMS = SAUCE_CONNECT_CLI_PARAMS.filter(p => p.type === 'boolean').map(p => p.name);
exports.SC_BOOLEAN_CLI_PARAMS = SC_BOOLEAN_CLI_PARAMS;
...
const SC_FAILURE_MESSAGES = ['Sauce Connect could not establish a connection', 'Sauce Connect failed to start'];
exports.SC_FAILURE_MESSAGES = SC_FAILURE_MESSAGES;
